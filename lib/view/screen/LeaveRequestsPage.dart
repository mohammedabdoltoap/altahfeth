          ...
          return Column(
            children: [
              Expanded(
                ...
                //     عرض بطاقة الإجازة رقم i
                //   }
                //
                // 💡 الفرق المهم:
                // - ListView.builder أذكى وأسرع! يعرض فقط العناصر المرئية على الشاشة
                // - لو عندك 1000 طلب إجازة، ما يرسم إلا اللي تشوفهم (حوالي 5-10)
                // - لما تسكرول للأسفل، يرسم العناصر الجديدة ويحذف القديمة
                //
                // 📊 المعاملات (Parameters):
                // - itemCount: عدد العناصر (مثل i < length في for)
                // - itemBuilder: الدالة اللي تبني كل عنصر (مثل جسم for)
                // - index: رقم العنصر الحالي (مثل i في for)
                // ════════════════════════════════════════════════════════════════
